...
export const DEFAULT_META: PageMeta = {
  title: 'FlameFinance',
  description:
    'The most popular AMM on CELO by user count! Earn CAKE through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by PancakeSwap), NFTs, and more, on a platform you can trust.',
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    ...
    defaultTitleSuffix: t('FlameFinance'),
  }
}
